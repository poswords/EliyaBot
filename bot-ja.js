...
const commandFiles = fs.readdirSync('./commands-ja').filter(file => file.endsWith('.js'));

for (const file of commandFiles) {
  const commands = require(`./commands-ja/${file}`);
...
client.login(process.env.DISCORD_TOKEN_JA);